...
class PaymentFilter(filters.FilterSet):
    content_type = filters.CharFilter(label="Фильтр по типу продукта (course|lesson...)", method="content_type_filter")
    type = filters.CharFilter()
    content_object_id = filters.NumberFilter(label="Фильтр по определенному продукту", method="content_object_filter")
